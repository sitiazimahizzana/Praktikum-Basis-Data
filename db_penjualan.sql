...
--
-- Host: 127.0.0.1
-- Generation Time: May 23, 2026 at 03:42 PM
...
(1, 'Hongshi', 'Jl. Merdeka'),
(2, 'William', 'Jl. Sudirman');
...
INSERT INTO `transaksi` (`id_transaksi`, `kode_produk`, `jumlah_harga`, `total_harga`, `id_pelanggan`) VALUES
(1, 'P001', 2, 14000000, 1),
(2, 'P002', 5, 750000, 2);
...
ALTER TABLE `transaksi`
  ...
  ADD KEY `idx_total_harga_baru` (`total_harga`);
